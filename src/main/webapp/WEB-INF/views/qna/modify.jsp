			...
			<div class="qnaform">
				<form role="form" method="post">
					<div class="qnaform__category outside">					
						...
						이게 뭐지?
						--%>
						<input type="hidden" name="no" value="${QNAVO.qnaNo}">
					...
					<div class="qnaform__title outside">					
						...
						<span class="right"><input name="qnaTitle" value="${QNAVO.qnaTitle}"></span>
					</div>
					<div class="qnaform__content outside">				
						<span class="left">내용</span>
						<span class="right"><textarea name="qnaContent">${QNAVO.qnaContent}</textarea></span>
					</div>
