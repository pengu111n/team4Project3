...
<%--                                    <h4 class="info-text"> 인테리어 견적 신청</h4>--%>
                                        ...
                                        <div class="form-group">
                                            <label>시공 내용 <small>시공내용을 간략하게 적어주세요 (20자이내)</small></label>
                                            <input  name="title" id="title" type="text" class="form-control" placeholder="시공내용을 간략하게 적어주세요 (20자이내)" style="margin:0; padding:0; width: 400px;">
                                        </div>
